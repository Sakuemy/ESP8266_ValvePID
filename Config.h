...
// ---------------------- Пины ----------------------
// Плата - NodeMCU ESP8266 V3 со встроенным OLED (SSD1306), у которого I2C
// разведён производителем на D5(SCL)/D6(SDA) - это НЕ пины I2C по
// умолчанию для ESP8266 (D1/D2), но т.к. дисплей уже распаян на плате,
// менять нечего - DS18B20 и сервопривод пришлось пересадить на
// освободившиеся D1/D2, чтобы не конфликтовать с занятыми D5/D6.
#define PIN_ONE_WIRE      D1   // GPIO5  - шина DS18B20
#define PIN_SERVO         D2   // GPIO4  - управляющий сигнал сервопривода
#define PIN_OLED_SDA      D6   // GPIO12 - I2C SDA встроенного дисплея (распаян производителем платы)
#define PIN_OLED_SCL      D5   // GPIO14 - I2C SCL встроенного дисплея (распаян производителем платы)
